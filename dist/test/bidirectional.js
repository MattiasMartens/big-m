...
require('should');
describe_this_1.describeThis(bidirectional_1.BiMap, subject => {
    ...
    it("Should be instantiable from another BiMap", () => {
        ...
        iterable_1.collect(newInstance).should.deepEqual(iterable_1.collect(instance));
    });
    describe("reversed", () => {
        it("Should have a reversed version which mirrors it", () => {
            ...
            utils_1.defined(instance.reversed.get(1)).should.equal("xx");
            utils_1.defined(instance.get("xx")).should.equal(1);
            instance.reversed.clear();
            iterable_1.collect(instance.entries()).should.deepEqual(iterable_1.collect(instance.reversed.entries()));
        });
