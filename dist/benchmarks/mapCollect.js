...
const array = pipeable_1.pipe(iterable_1.count(), a => iterable_1.take(a, 100000), a => iterable_1.map(a, v => mapFn(v)), iterable_1.collect);
suite
    ...
    .run({ 'async': false });
const suite2 = new benchmark_1.Suite;
suite2
